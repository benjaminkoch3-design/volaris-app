                  ...
                  const zones = [
                    {
                      ...
                      badge: "bg-[#4D80B3]/20 text-[#4D80B3] border-[#4D80B3]/40",
                    },
                    {
                      zone: "Z2",
                      pct: "60–70 %",
                      ...
                      >
                        <div className="space-y-2">
                          <input
                            type="text"
                            required
                            placeholder="Nom de la course (Ex: Maxi-Race Trail)"
                            value={newRace.name}
                            onChange={(e) =>
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <input
                              type="text"
                              required
                              placeholder="Distance (Ex: 25 km, 10 km)"
